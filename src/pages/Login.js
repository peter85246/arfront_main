                                ...
                                <InputGroup className="mb-3">
                                    ...
                                    {(() => {
                                        switch (errors.account) {
                                            case 'required':
                                                return <div className="invalid-feedback d-block"><i className="fas fa-exclamation-circle"></i> 不得空白</div>
                                            default:
                                                return null
                                        }
                                    })()}
                                    ...
                                    {(() => {
                                        switch (errors.paw) {
                                            case 'required':
                                                return <div className="invalid-feedback d-block"><i className="fas fa-exclamation-circle"></i> 不得空白</div>
                                            case 'pawFormat':
                                                return <div className="invalid-feedback d-block"><i className="fas fa-exclamation-circle"></i> 格式有誤</div>
                                            default:
                                                return null
                                        }
                                    })()}
