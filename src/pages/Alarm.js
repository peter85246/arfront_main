      ...
      <div>
        <div className={styles["buttons-container-item"]}>
          <div className={styles["buttons-alarm"]}>
            ...
            <span className={styles["drop-down-arrow-alarm"]} onClick={() => setDropMenuOpen((prev) => !prev)}>
              ▼
            </span>
            {dropMenuOpen && (
              <ul className={styles["custom-datalist-alarm"]}>
                <li onClick={() => setAlarmValue('GXA-S GXA-H GVA GFA-S GFA-H GTF GTFAE Series')}>
        ...
        <div className={styles["content-box-left-alarm"]}>
          ...
          <div className={styles["menu"]}>
            ...
            <div className={styles["menu-item-alarm"]}>
              <div className={styles["collapsible"]} onclick="toggleContent(event, this)">
