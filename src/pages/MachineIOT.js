...
function MachineIOT() {
    ...
    const [machineIOT, setMachineIOT] = useState({ //IOT資料
    ...
    const [machineIOTErrors, setMachineIOTErrors] = useState({ //IOT資料 - 錯誤訊息
        machineIOTDeviceName: "",
        machineIOTMQTTBroker: "",
        machineIOTClientId: "",
        machineIOTUserName: "",
    ...
    const [selectTopic, setSelectTopic] = useState({ //被選中的Topic
        index: -1,
        deleted: 0,
        topicId: 0,
        machineIOTId: 0,
    ...
    const [topicErrors, setTopicErrors] = useState({ //Topic - 錯誤訊息
        topicValue: ""
    });
    ...
    const checkEditValidator = async (name = "", val = "") => {
        ...
        if (name == "machineIOTDeviceName" || name == "") {
            ...
            else if (!validator.check(machineIOT.machineIOTDeviceName, "max:1000")) {
        ...
        if (name == "machineIOTMQTTBroker" || name == "") {
            ...
            else if (!validator.check(machineIOT.machineIOTMQTTBroker, "max:1000")) {
        ...
        if (await checkEditValidator()) {
            ...
            if (saveMachineIOTResponse) {
                if (saveMachineIOTResponse.code == "0000") {
                    refreshMachineIOT();
                    toast.success(machineIOTId == 0 ? t("toast.add.success") : t("toast.edit.success"), {
    ...
    return (
        <>
            <section className="content-header">
                <div className="container-fluid">
                    <div className="d-flex mb-2 justify-content-between align-items-center">
                        <div>
                            <a href={`/machine/${machineId}/machineIOTList`} className="d-flex align-items-center">
                                <i className="fas fa-angle-left"></i>&nbsp;&nbsp;{t("machineIOTList.content.header")}{/*IOT管理*/}
                            </a>
                        </div>
                        <div className="content-header-text-color">
                            <h1><strong>{machineIOTId == 0 ? t("machineIOT.content.header.add") : t("machineIOT.content.header.edit")}{/*新增IOT:編輯IOT*/}</strong></h1>
                        </div>
                        <div>
                            <button
                                type="button"
                            ...
                            <div className="machineIOT-col-border-l">
                                <div className="row mb-3">
                                    <div className="col form-group">
                                        <label className="form-label"><span className="text-danger">*</span>{t("machineIOT.machineIOTDeviceName")}{/*設備名稱*/}</label>
                                        <input
                                            type="text"
                                ...
                                <div className="row mb-3">
                                    <div className="col form-group">
                                        <label className="form-label"><span className="text-danger">*</span>{t("machineIOT.machineIOTMQTTBroker")}{/*Server*/}</label>
                                        <input
                                            type="text"
                                            className="form-control"
                                ...
                                <div className="row mb-3">
                                    <div className="col form-group">
                                        <label className="form-label"><span className="text-danger">*</span>{t("machineIOT.machineIOTClientId")}{/*Client ID*/}</label>
                                        <input
                                            type="text"
                                            className="form-control"
                                ...
                                <div className="row mb-3">
                                    <div className="col form-group">
                                        <label className="form-label"><span className="text-danger">*</span>{t("machineIOT.machineIOTUserName")}{/*Username*/}</label>
                                        <input
                                            type="text"
                                            className="form-control"
                                ...
                                <div className="row mb-3">
                                    <div className="col form-group">
                                        <label className="form-label"><span className="text-danger">*</span>{t("machineIOT.machineIOTPassword")}{/*Password*/}</label>
                                        <input
                                            type="password"
                                            className="form-control"
                            ...
                            <div className="machineIOT-col-border-r">
                                            ...
                                            <div key={index} className="mb-2 machineIOT-topic">
                                                <div className="row align-items-center">
                                                    <div className="col-10">
                                                        <div>topic:</div>
                                                        <div style={{ wordBreak: "break-all" }}>{item.topicValue}</div>
                                                    </div>
                                                    <div className="col-2 text-right">
                                                        <button type="button" className="btn btn-outline-primary btn-circle btn-sm" onClick={() => handleOpenTopicModal(index)}>
                                                            <i className="fas fa-edit"></i>
                                                        </button>
                                                        <button type="button" className="btn btn-outline-danger btn-circle btn-sm ml-1" onClick={() => handleOpenDeleteTopicModal(index)}>
                                ...
                                <div className="row">
                                    <div className="col-12">
                                        <button type="button" className="btn btn-primary machineIOT-topic-btn-add" onClick={() => handleOpenTopicModal(-1)}><i
            ...
            <Modal show={showTopicModal} onHide={(e) => handleCloseTopicModal(e)} backdrop="static">
                <Modal.Header closeButton>
                    <Modal.Title>{t("machineIOT.updateTopic")}{/*Topic*/}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <form>
                        <div className="row mb-3">
            ...
            <Modal show={showDeleteTopicModal} onHide={(e) => handleCloseDeleteTopicModal(e)} backdrop="static">
                <Modal.Header closeButton>
                    <Modal.Title>{t("machineIOT.deleteTopic")}{/*刪除Topic*/}</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <p>{t("machineIOT.deleteContent")}{/*您確定要刪除該筆資料嗎?*/}</p>
                </Modal.Body>
                <Modal.Footer>
                    <button
                        type="button"
